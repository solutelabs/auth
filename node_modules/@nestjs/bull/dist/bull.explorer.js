...
let BullExplorer = class BullExplorer {
    ...
    explore() {
        const providers = this.discoveryService
            ...
            .filter((wrapper) => {
            var _a;
            return this.metadataAccessor.isQueueComponent(!wrapper.metatype || wrapper.inject
        ...
        providers.forEach((wrapper) => {
            ...
            const { name: queueName, } = this.metadataAccessor.getQueueComponentMetadata(instance.constructor || metatype);
    ...
    getQueue(queueToken, queueName) {
        try {
            ...
            this.logger.error((0, bull_messages_1.NO_QUEUE_FOUND)(queueName));
            throw err;
        }
    }
